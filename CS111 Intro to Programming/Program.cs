...
namespace ConsoleApplication42
{
    class Program
    {
        ...
        static void Fight()
        {
            ...
            fight += "\nYou have had no experience with any form of combat whatsoever,\nyet, you felt that same force that kept you from falling before now guiding your\nevery movement.";
            fight += "\nYou keep fighting him with your sword and using your shieldto block\nhis fiery darts. This goes on for half a day and you begin to grow wearier\nthan you thought possible.";
        ...
        static void Palace()
        {
            string palace = "You decide that you have gone too far to return home. You go back to the palace.";
            palace += "\nWhen you arrive you are told that you cannot stay. Either continue to the Celestial City or go home.";
        ...
        static void Path()
        {
            string path = "You continue on the path and arrive at a point where the road takes a sharp turn to the right. You can see across a large meadow that the road just goes around it.";
            path += "You could save yourself some time and energy if you just jump the fence and cut across this meadow.";

            Console.WriteLine(path);

            string prompt = "Do you want to cut across the meadow or follow the road?";
            prompt += "\n(\"meadow\" or \"road\")";
        ...
        {
            string doubtingCastle = "You want to get to the Celestial City as quickly as possible. You see a \"No Tresspassing\" sign but ignore it.";
            doubtingCastle += "\nYou were walking across the meadow for about an hour when you notice that suddenly the sky grew dark and the wind started to blow harder.";
            doubtingCastle += "\nIt starts raining so hard that the meadow starts to get flooded. You run for higher ground and find some shelter. You can at least get some rest while the storm settles down.";
            doubtingCastle += "\nBefore you know what has happened, you fall asleep.";
            doubtingCastle += "\nYou awake to the sound of a low thudding noise. You remember the events of the previous night and get ready to continue on your journey.";
            doubtingCastle += "\nJust as you are about to leave the meadow, you turn your head to see the source of the thudding that has steadily grown louder: a giant.";
            doubtingCastle += "\nYou try to run away but, the giant was already too close. He captures you and takes you to his castle. His castle was not at all a pleasant place to be. The entire area was engulfed in darkness cast by the large trees.";
            doubtingCastle += "\nInside the castle was even darker. It smelled of death and pain. You could hear the cries of pain of the giants prisoners.";
            doubtingCastle += "\nThe giant takes you to your cell where you see a body chained to the wall. You are also chained to the wall and locked in the cell.";
            doubtingCastle += "\nWhen the giant leaves you hear a voice come from the body. It turns out that he is also a traveler to the Celestial City. He was captured the same way you were and has been imprisoned there for three months.";
            doubtingCastle += "\nYou and your new companion talk about the book that both of you had been reading, your troubles on the way to the Celestial City, and your hopes of escaping.";
            doubtingCastle += "\nAbout a month later, the giant enters the cell with a bottle. He says that you have the option to drink the poison to end your torment, or you can continue living as you are and the giant will find a much more painfull death for you.";
            doubtingCastle += "\nThinking that you were too weak to make any attempt of escape, he unchains both of you so that you can drink the poison.";
        ...
        static void Poison()
        {
            string poison = "You decide to drink the poison. You have gone through enough torment on this journey. It is time to end it.";
            poison += "\nYou awake in a dungeon. You feel pain all over your body. You realize that you had been taken to Apollyon's dungeon, where he eternally torments travellers to the Celestial City that left the correct path.";
            poison += "\nYou had betrayed the King and now you are reaping the consequences. Here you will spend eternity, alone.";
        ...
        static void Escape()
        {
            string escape = "You decide that if you drink the poison, you will never get to see the Celestial City. You pour the contents down the drain and continue to talk with your friend.";
            escape += "\nSuddenly, you remember the key that was given to you. You had been wearing it around your neck the entire time. Even though it is much too small for the lock on the door, you try it anyway.";
            escape += "\nTo your surprise, the key unlocks the door and, with your friends help, you push the door open.";
            escape += "\nOn your way out you unlock other doors to let other prisoners escape, some of which could barely stand.";
            escape += "\nEveryone runs out of the castle into the forest, and then out of the forest and back onto the road.";
            escape += "\nFor now, most of the group stays together to share stories.";
            escape += "\nAs you continue, the group begins thinning out. Some lagging behind due to weakness, others running ahead for joy of being freed.";
            escape += "\nEventually, just your new companion has stayed with you. Soon, your friend grows tired and slows down. He tells you to go ahead and that you shall meet him in the Celestial City.";
        ...
        {
            string enchantedGround = "You continue walking and soon come to a point where the road ends. Right in front of you is a field. You have been warned about it.";
            enchantedGround += "\nThe only way is to go through it, but you need to be careful. Of what, you were no told.";
            enchantedGround += "\nAs you continue, you slowly fall asleep. Several times you catch yourself dozing off.";

            Console.WriteLine(enchantedGround);

            string prompt = "\nShould you just take a short nap and continue when you have more energy or should you resist and continue through the field.";
            prompt += "(\"sleep\" or \"continue\")";
        ...
        static void Sleep()
        {
            string sleep = "You cannot resist any longer. You collapse and immediately slip into dreams. But you never\nwake\nup.";
        ...
        static void Final()
        {
            string final = "You resist the sleepiness and continue stumbling along. Just as you feel that you can't go any longer you feel a surge of energy. This surge gave you the strength to continue until you left the field.";
            final += "\nYou soon arrive at a raging river. Just beyond the river you see the gateway to the Celestial City. Finally, after all that you have been through, you have only one obstacle left: the river.";
            final += "\nThe only way across it is to swim. You throw your armor and sword into the river. You will not be needing them after you cross the river. You quickly run in and start your swim across. About halfway across the river you feel yourself being pulled underneath the surface.";
            final += "\nInstead of panicking, like you would have before this journey, you feel completely at peace, as if even if you do drown, you will somehow still arrive at the Celestial City.";
            final += "\nYou make a final attempt, using all of your remaining energy. Before you knew what had happened, you climbed out of the water and collapsed onto the shore, relieved that your final trial has ended.";
            final += "\nYou get up and walk to the gates, where you are given a clean, white set of clothes. You walk into the city with a new burst of seemingly unending energy.";
            final += "\nHere you live for the rest of time, with no illness, death, pain, or sadness. Soon some of the travelers that you had freed arrived, as did your companion. Years later, even your family and a few friends arrived one way or another.";
        ...
        static void End()
        {
            ...
            string choice = UserChoice(prompt, "yes", "no", "no");
