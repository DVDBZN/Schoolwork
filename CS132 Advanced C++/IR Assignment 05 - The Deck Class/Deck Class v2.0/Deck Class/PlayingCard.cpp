...
{
	//This was causing errors, so it had to be commented out.
...
PlayingCard::PlayingCard(string newSuit, string newRank)
{
	//Validates suit
...
void PlayingCard::setValue(string newRank)
{
	//Validates value
	if (newRank == "Ace")
		value = 11;
	else if (newRank == "King" || newRank == "Queen" || newRank == "Jack")
		value = 10;
	else
		value = stoi(newRank.c_str());
}
